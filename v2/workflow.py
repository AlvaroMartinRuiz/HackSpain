...
from v2.models import CallState, Identity, Intent, Operation, RegistrationFields, Reply, SchedulingCriteria, TurnDecision
            ...
            if op.criteria:
                ...
                for insurer in op.criteria.insurers:
                    ...
                    if named not in known_plans and named not in normalize_text(text).replace("_", " "):
                        ...
                        return collection_prompt(intent, language)
                values.update(op.criteria.model_dump(exclude_none=True, exclude_unset=True))
